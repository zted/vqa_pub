...
options['qah5'] = 'data_prepro_shuffled_LSTMCNN.h5' # this file contains question features, image positions, etc.
options['img_train'] = 'vqa_img_vgg_fc_trainval.h5' # image features file
